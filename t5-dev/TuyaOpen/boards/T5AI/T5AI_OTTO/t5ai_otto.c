 ...
 ***********************************************************/
 ...
 #if (defined(T5AI_OTTO_EX_MODULE_ST7789) && (T5AI_OTTO_EX_MODULE_ST7789 == 1)) || \
     (defined(T5AI_OTTO_EX_MODULE_ST7735S_XLT) && (T5AI_OTTO_EX_MODULE_ST7735S_XLT == 1)) || \
     (defined(T5AI_OTTO_EX_MODULE_GC9D01) && (T5AI_OTTO_EX_MODULE_GC9D01 == 1))
 ...
 #if defined(T5AI_OTTO_GC9D01_BL_ACTIVE_LOW) && (T5AI_OTTO_GC9D01_BL_ACTIVE_LOW == 1)
